...
circle1_points = generate_circle(-sep_dist/2 - rad + int_dist/2, 0, rad, n_samples)
circle2_points = generate_circle(sep_dist/2 + rad - int_dist/2, 0, rad, n_samples)


int_circle1_points = generate_circle(-sep_dist/2 + int_dist/2, 0, rad, n_samples)
int_circle2_points = generate_circle(sep_dist/2 - int_dist/2, 0, rad, n_samples)
...
axs[0].add_artist(plt.Circle((-sep_dist/2, 0), rad, facecolor='none', edgecolor='blue'))
axs[0].add_artist(plt.Circle((sep_dist/2, 0), rad, facecolor='none', edgecolor='red'))
axs[0].set_xlim(-rad*2, rad*2)
...
axs[1].add_artist(plt.Circle((-sep_dist/2, 0), rad, facecolor='none', edgecolor='blue'))
axs[1].add_artist(plt.Circle((sep_dist/2, 0), rad, facecolor='none', edgecolor= 'red'))
